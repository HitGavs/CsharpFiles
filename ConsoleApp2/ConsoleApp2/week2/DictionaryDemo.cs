...
namespace ConsoleApp2.week2
{
    internal class DictionaryDemo
    {
...

        {
            ...
            Emp e5 = new Emp() { ID = r1.Next(100), Name = "amigo", Salary = r1.NextDouble() * 5000 };

            Emp e6 = new Emp() { ID = r1.Next(100), Name = "Balaya", Salary = r1.NextDouble() * 5000 };

            Emp e7 = new Emp() { ID = r1.Next(100), Name = "NTR", Salary = r1.NextDouble() * 5000 };

            Emp e8 = new Emp() { ID = r1.Next(100), Name = "PSPK", Salary = r1.NextDouble() * 5000 };

            Emp e9 = new Emp() { ID = r1.Next(100), Name = "charanya", Salary = r1.NextDouble() * 5000 };
            ...
            if (!empsortlist.ContainsKey(e6.ID))

                empsortlist.Add(e6.ID, e6);

            if (!empsortlist.ContainsKey(e7.ID))

                empsortlist.Add(e7.ID, e7);

            if (!empsortlist.ContainsKey(e8.ID))

                empsortlist.Add(e8.ID, e8);

            if (!empsortlist.ContainsKey(e9.ID))

                empsortlist.Add(e9.ID, e9);
